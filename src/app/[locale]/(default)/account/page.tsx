...
import SectionBasicInformation from "@/app/(module)/(core)/ui/account/SectionBasicInformation";
import SectionAddressBook from "@/app/(module)/(core)/ui/account/SectionAddressBook";
